...
```#
# THIS FILE WAS AUTO GENERATED BY SCALR-SERVER-WIZARD
#
# YOU CAN FIND THE FULL SET OF CONFIGURATION OPTIONS IN OUR WIKI:
...
# Scalr web UI URL
routing[:endpoint_host] = "192.168.236.128"

# Following IPs will be whitelisted on Scalr controlled instances
app[:ip_ranges] = ["192.168.236.128/32"]
